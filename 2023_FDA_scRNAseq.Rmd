...
V1 <- scell_V1
#Rename V1 cell population hCSC
V1$cell <- "hCSC"
...
#save(scell.NormalizeData, file = "//bhatiaserv.mcmaster.ca/data/Bhatialab/Shared_Personal_Folders/Alice Feng/2 Data Files/scRNAseq/output/scell.NormalizeData.RData")
...
scell.combined_NormalizeData <- RunUMAP(scell.combined_NormalizeData, reduction = "pca", dims = 1:30)
scell.combined_NormalizeData <- RunTSNE(scell.combined_NormalizeData, reduction = "pca", dims = 1:30)
scell.combined_NormalizeData <- FindNeighbors(scell.combined_NormalizeData, reduction = "pca", dims = 1:30)
...
wrap_plots(plots = plot_gene_2, ncol=1)
